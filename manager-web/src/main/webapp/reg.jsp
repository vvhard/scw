...
<body>
	...
	<div class="container">
		...
		<form id="regForm" class="form-signin" role="form" action="${ctp}/permission/user/reg" method="post">
			...
			<div class="form-group has-success has-feedback">
				<input type="text" class="form-control" name="loginacct" id="loginacct_input" placeholder="请输入登录账号" autofocus value="${user.loginacct}"> 
			...
			<div class="form-group has-success has-feedback ">
				<input type="text" class="form-control" name="email" id="email_input" placeholder="请输入邮箱地址" style="margin-top: 10px;" value="${user.email}">
	...
	<script type="text/javascript">
		...
		$("#submitBtn").click(function() {
			// 获取注册用户类型
			var userType = $("select.form-control").val();
			if(userType == "管理")
				$("#regForm").submit();
			else
				alert("功能尚未开通");
