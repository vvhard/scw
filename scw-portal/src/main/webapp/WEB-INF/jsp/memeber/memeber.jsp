...
<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="thumbnail" style="    border-radius: 0px;">
						<img src="${ctp }/static/img/services-box1.jpg" class="img-thumbnail" alt="">
						<div class="caption" style="text-align:center;">
							<h3>
								${loginUser.username }
							</h3>
							<span class="label label-danger" style="cursor:pointer;" onclick="window.location.href='${ctp}/member/auth.html'">${loginUser.realname }</span>
						</div>
					</div>
				</div>
			</div>
    ...
    <script src="${ctp }/static/script/echarts.js"></script>
